...
function GodefUnderCursorH()
 let g:godef_split=1
 call GodefUnderCursor()
endfunction

function GodefUnderCursorV()
 let g:godef_split=3
 call GodefUnderCursor()
endfunction

autocmd FileType go nnoremap <buffer> gd :call GodefUnderCursorH()<cr>
autocmd FileType go nnoremap <buffer> gv :call GodefUnderCursorV()<cr>
